...
Each property has an "enquire with" contact (name + WhatsApp number). When an agent asks who to contact for a viewing, visit, or booking, share the contact name and number for the specific property they asked about. If they didn't specify a property but the conversation was about a specific property, use that one. This is a factual, confident answer — use action "auto", not "escalate".
