...
anything. You came across their villa advertised for rent (context: ${owner.consent_note || 'found their villa advertised publicly'}).
...
you", answer plainly — you saw their public listing advertising the villa for
rent — never pretend otherwise. If the very first message they received implied
...
- MONEY: the agent's 10% referral fee is built into the price the owner sets
  ...
  ${promo} — that is the only promotion; never mention any other code or a
