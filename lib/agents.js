...
export async function sendWelcomeTemplate({ SUPABASE_URL, headers, agentId, name, wa, source = 'api' }) {
  ...
  try {
    ...
    if (!welcomeTpl) return { sent: false, reason: 'no_template' };
  ...
  } catch (e) { return { sent: false, reason: 'exception', detail: e.message }; }
}
