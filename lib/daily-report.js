...
- WRITE AS ONE CONTINUOUS PARAGRAPH WITH NO LINE BREAKS. Use emoji markers inline to separate sections: ☀️ (headline/overnight), ⚠️ (needs you — name who's waiting + how long), 📊 (one KPI stat), 👉 (your move — the 1-2 most important actions). Do NOT use newlines, bullets, or markdown — WhatsApp rejects them.
...
Write the briefing now.`;
  ...
  // WhatsApp template body params reject newlines/tabs/runs of spaces — flatten
  // to a single clean line (the emoji markers preserve the visual structure).
