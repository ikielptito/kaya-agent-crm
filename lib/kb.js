...
2. TROPICAL TOWNHOUSES (Tropicana Valley) — Buduk (5 min from Pererenan)
   ...
   Features: Private plunge pool per unit, loft-style bedroom, built-in workspace, soaking tub, shaded terrace. Rental management available.
   ROI projections (net of expenses): 60% occ = 14.4%, 70% occ = 17.28%, 80% occ = 20.16%. Projected ADR ~$100 USD.
