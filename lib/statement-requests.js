...
export async function handleStatementChangeRequest({ db, wa, fromNum, fromName = 'Era', text, apiKey, mediaType = null, mediaId = null, caption = null, fetchImage = null, force = false }) {
  ...
  if ((!pending || pending.seed) && !force && !GATE_RE.test(body)) return false;
