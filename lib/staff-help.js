...
const ACK = /^\s*(ok|oke|okay|baik|siap|ya|yes|iya|terima kasih|makasih|thanks|thank you|thx|👍|🙏|sip|noted)[\s.!🙏👍]*$/i;
...
- Tidak semua villa sama. Tidak ada oven → foto dapurnya tetap: meja, kompor, dan microwave kalau ada; tulis "tidak ada oven". Tidak ada kolam → foto teras/halaman. Satu kamar mandi → satu foto. Dua lantai → foto keduanya. Aturannya: foto bagian yang ADA, dan tulis keterangan singkat supaya Maya tahu. Ini tidak perlu ditanyakan ke Era.
