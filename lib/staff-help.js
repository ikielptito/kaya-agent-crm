...
// ── The answer ──────────────────────────────────────────────────────
export async function answerStaffQuestion({ db, wa, fromNum, text, role, person = null, apiKey = process.env.ANTHROPIC_API_KEY, dryRun = false }) {
...
- Jangan mengarang aturan. Kalau tidak ada di SOP atau konteks, bilang kamu tidak yakin dan sarankan tanya Era (untuk housekeeper) atau Ikiel (untuk Era).
