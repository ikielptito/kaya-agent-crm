...
export const DEFAULT_STANDARD = {
  ...
  photo_spots: [
    ...
    { key: 'kitchen', id: 'dapur (meja, kompor, dan bagian dalam oven)', en: 'Kitchen: counter, hob and inside the oven' },
...
export const DEEP_CLEAN_ID = 'pembersihan menyeluruh: lap semua dinding dan lis, bagian dalam oven, kaca luar termasuk lantai atas, nat kamar mandi, bantal kolam dicuci, dispenser dibersihkan';
export const DEEP_CLEAN_EN = 'Deep clean: all walls and skirting, inside the oven, exterior windows including upstairs, bathroom grout, pool cushions washed, dispenser sanitised';
