...
export const EVIDENCE_LABEL = { photos: 'with photos', reported: 'reported on the day', reported_late: 'reported later' };

export const STATUS_LABEL = {
  done: 'Done', skipped: 'Skipped', not_done: 'Not done', unconfirmed: 'Not confirmed', not_sent: 'Never sent', uncovered: 'Uncovered', open: 'Today, open', upcoming: 'Upcoming',
...
export const OWNER_STATUS_LABEL = {
  ...STATUS_LABEL,
  done: 'Cleaned', not_done: 'Not cleaned', unconfirmed: 'Visit not confirmed', not_sent: 'Visit not covered', uncovered: 'Visit not covered', open: 'In progress today',
...
export async function buildRecords(db, { from, to, slugs = null, limit = 1500, audience = 'era' } = {}) {
  ...
  for (const x of tasks) {
    ...
    const rec = {
      ...
      done_at: x.done_at || null, photo_count: photos.length, evidence: evidenceOf({ ...x, photos }),
