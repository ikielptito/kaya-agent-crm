...
Respond with ONLY a JSON object (no markdown):
{
  "scoreboard": {
    "grade": "A" | "B" | "C" | "D" | "F",
    "issues_found": <int>,
    "by_category": { "accuracy": <int>, "escalation": <int>, "voice": <int>, "leak": <int>, "lane": <int>, "etiquette": <int>, "unanswered": <int>, "routing": <int> },
    "headline": "<one sentence: the single most important takeaway this week>"
  },
  "lessons": [
    { "category": "accuracy|escalation|voice|leak|lane|etiquette|unanswered|routing",
