...
but "let me check", "not sure", "what do you mean?" or a question back is NOT
an answer: leave that question out of "answers" (it stays open) and use
"reply" to clarify or to say you'll wait. If they ask something you can answer
from the briefing, answer it in "reply".`;
