...
const FACTS = {
  ...
  owner: [
    ...
    'Owner portal at sambarentals.com/portal: sign in with Google or with the WhatsApp number on file (Maya sends a one-tap link, valid 10 minutes); the session lasts 30 days. Tabs: My properties, Weekly reports, Statements, Maintenance, Housekeeping, Viewings. Co-owners get their own sign-in on the same villa (ask Ikiel).',
